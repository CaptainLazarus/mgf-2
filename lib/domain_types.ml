type symbol = Terminal of string | NonTerminal of string | Epsilon | EOF
...
type action = Shift of int | Reduce of production_rule | Accept | Goto of int
...
type token_info = { token : symbol; lexeme : string }
